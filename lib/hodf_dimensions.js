...
YearDimension.prototype.parameterHtml = function () {
    return [
        '<label><span lang="en">Start year</span><span lang="es">Año de inicio</span>: <input type="number" name="min" min="' + this.overall_min + '" max="' + this.overall_max + '" step="1" value="' + this.min + '" /></label>',

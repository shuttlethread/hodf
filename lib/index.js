...
function Hodataframe(tmpl, el, inital_data, initial_lang) {
    ...
    customData.fields = get_dimension(tmpl.fields, inital_data._headings.fields, initial_lang);
    customData.values = get_dimension(tmpl.values, inital_data._headings.values, initial_lang);

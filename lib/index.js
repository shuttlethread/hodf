...
function Hodataframe(tmpl, el, inital_data, initial_lang) {
    ...
    hotParams.data = inital_data._headings.fields ? hodf_utils.df_to_aofa(inital_data, inital_data._headings.fields, inital_data._headings.values, tmpl.orientation) : undefined;

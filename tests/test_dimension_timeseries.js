...
test('TimeSeriesDimension', function (t) {
    ...
    t.deepEqual(d.parameterHtml(), [
        ...
        '<select name="period">',
        '<option value="1" selected="selected" lang="en">Yearly</option>',
        '<option value="1_7" lang="en">Bi-annual</option>',
        '<option value="1_4_7_10" lang="en">Quarterly</option>',
        '<option value="1_2_3_4_5_6_7_8_9_10_11_12" lang="en">Monthly</option>',
        '</select>',
        '</label>&nbsp;</span>',
    ...
    t.deepEqual(d.parameterHtml(), [
        ...
        '<select name="period">',
        '<option value="1_4_7_10" selected="selected" lang="en">Quarterly</option>',
        '<option value="1_2_3_4_5_6_7_8_9_10_11_12" lang="en">Monthly</option>',
        '</select>',
        '</label>&nbsp;</span>',
...
test('TimeSeriesDimension:update_init', function (t) {
    ...
    t.deepEqual(d.parameterHtml(), [
        ...
        '<option value="1_7" selected="selected" lang="en">Bi-annual</option>',
        '<option value="1_4_7_10" lang="en">Quarterly</option>',
        '<option value="1_2_3_4_5_6_7_8_9_10_11_12" lang="en">Monthly</option>',
        '</select>',
        '</label>&nbsp;</span>',
